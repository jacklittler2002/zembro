-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('CAMPAIGN_COMPLETED', 'LEAD_SEARCH_COMPLETED', 'CREDIT_LOW', 'EMAIL_BOUNCED', 'CAMPAIGN_ERROR', 'SYSTEM_MAINTENANCE', 'NEW_FEATURE');

-- CreateEnum
CREATE TYPE "IntegrationType" AS ENUM ('ZAPIER', 'MAKE', 'WEBHOOK', 'SLACK', 'DISCORD', 'GOOGLE_SHEETS', 'HUBSPOT', 'SALESFORCE', 'PIPEDRIVE', 'ZOHO');
...
CREATE TABLE "UserPreferences" (
    ...
    "leadSearchNotifications" BOOLEAN NOT NULL DEFAULT true,
